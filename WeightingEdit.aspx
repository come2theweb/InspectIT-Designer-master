<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WeightingEdit.aspx.cs" Inherits="InspectIT.WeightingEdit" %>
                ...
                <div id="plumber">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group form-group-default">
                                <label>Qualified/Technical/Learner:</label>
                                <div class="controls">
                                    <asp:TextBox ID="Qualified" runat="server" CssClass="form-control"  ></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group form-group-default">
                                <label>Licensed:</label>
                                <div class="controls">
                                    <asp:TextBox ID="Licensed" runat="server" CssClass="form-control"  ></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group form-group-default">
                                <label>Master:</label>
                                <div class="controls">
                                    <asp:TextBox ID="Mastertxt" runat="server" CssClass="form-control"  ></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group form-group-default">
