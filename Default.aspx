<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="InspectIT._default" %>
<!DOCTYPE html>
<html>
<head runat="server">
    <meta http-equiv="content-type" content="text/html;charset=UTF-8" />
    <meta charset="utf-8" />
    <title>InspectIT Login</title>
...
<body class="fixed-header" style="margin-top: -30px;">
        ...
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
          ...
          <!-- START Login Form -->
            ...
            <div class="form-group form-group-default">
              ...
              <div class="controls">
                <asp:TextBox ID="password" runat="server" placeholder="Enter your password" CssClass="form-control" required TextMode="Password"></asp:TextBox>
              </div>
            </div>
            <!-- START Form Control-->
            <div class="row">
              <div class="col-md-6 no-padding"><asp:Button ID="SignIN" runat="server" Text="Sign in" CssClass="btn btn-primary btn-cons" OnClick="SignIN_Click" /></div>
              <div class="col-md-6 text-right">
                <a href="Forgotpass" class="text-info small">Help? Forgot your password</a>
              </div>
            </div>
            <!-- END Form Control-->
            <!-- START Form Control-->
    ...
    <!-- END PAGE LEVEL JS -->
    <script>
        $("#<%=SignIN.ClientID%>").click(function () {
            $('#form1').validate()
        });
    </script>
