...
namespace InspectIT
{
    public partial class PerformanceTypes : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DLdb.RS.Open();
            DLdb.SQLST.CommandText = "SELECT * FROM performancetypes where isActive='1'";
            ...
            if (theSqlDataReader.HasRows)
            {
                while (theSqlDataReader.Read())
                {
                    displayusers.InnerHtml += "<tr>" +
                                                       ...
                                                       "<div class=\"btn " + delBtnClass + " btn-sm btn-danger\" onclick=\"deleteconf('DeletePerformanceType.aspx?op=del&id=" + theSqlDataReader["PerformanceID"].ToString() + "')\"><i class=\"fa fa-trash\"></i></div></td>" +
                                                   "</tr>";
                }
            }
        ...
        {
            Response.Redirect("PerformanceTypesEdit");
        }
    }
}