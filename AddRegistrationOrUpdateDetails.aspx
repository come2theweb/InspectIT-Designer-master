<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AddRegistrationOrUpdateDetails.aspx.cs" Inherits="InspectIT.AddRegistrationOrUpdateDetails" %>
    ...
    <div class="container-fluid container-fixed-lg bg-white">
        <div class="panel panel-transparent">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="auto-style1">
                        <asp:Button ID="btn_AddDetails" CssClass="btn btn-primary" Style="float: right;" runat="server" Text="Add Details" OnClick="btn_AddDetails_Click" />
                    </div>
                </div>
