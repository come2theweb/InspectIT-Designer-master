<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="InspectorComments.aspx.cs" Inherits="InspectIT.InspectorComments" %>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="auto-style1">
                        <a href="InspectorCommentsAdd.aspx">
                            <input type="button" value="Add New Statement" class="btn btn-primary" style="float: right;" />
                        </a>
                    </div>
                </div>
                <!-- END Form Control-->
