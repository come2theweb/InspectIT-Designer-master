	...
	return function (t) {
		...
		var o = e(34),
			...
			p = function () {
				...
				return t = f({}, t), t.readOnly = t.readOnly || !1, t.reflectToAttribute = t.reflectToAttribute || !1, t.value = t.value, t.type = t.type, t
			},
			d = function (t) {
				...
				var r = {
					...
					configurable: !0,
					writable: !n.readOnly,
					value: u(n.value) ? n.value.call(e) : n.value
				};
				Object.defineProperty(e, t, r)
			},
			v = function (t, n, e) {
				n && !e[t] && (u(n) ? e[t] = n.call(e) : e[t] = n)
			},
			h = function (t) {
				var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
					e = arguments[2];
				if (n = p(n), n.reflectToAttribute) {
					var r = a("data-" + t),
						...
						i = {
							...
							get: function () {
								return n.type === Boolean ? "" === this.element.dataset[t] : this.element.dataset[t]
							},
							set: function (e) {
								if (n.type === Boolean) return this.element[e ? "setAttribute" : "removeAttribute"](r, n.type === Boolean ? "" : e);
			...
			m = function (t) {
				g(t).forEach(function (n) {
					var e = n.fn,
						r = n.args;
					t[e] = t[e].bind(t), r.forEach(function (n) {
						if (-1 !== n.indexOf(".")) {
							var r = b(n, t),
								i = r.prop,
								c = r.parent;
							Object(o.watch)(c, i, t[e])
						} else Object(o.watch)(t, n, t[e])
					})
				})
			},
			w = function (t) {
				return c(t.listeners) ? t.listeners.map(function (t) {
					var n = t.match(/(.*\.)?([a-zA-Z-_]+)\(([^)]*)\)/),
						...
						o = e[2],
						i = e[3];
					return i = i.split(",").map(function (t) {
						return t.trim()
					}).filter(function (t) {
						return t.length
					}), r = r ? r.substr(0, r.length - 1) : "element", {
							element: r,
							fn: o,
							events: i
						}
					...
					var e = n.element,
						r = n.fn;
					return u(t[r]) && ("document" === e || "window" === e || i(t[e]) || i(t[e].element))
				}) : []
			},
			x = function (t) {
				w(t).forEach(function (n) {
					var e = n.element,
						r = n.fn,
						o = n.events;
					t[r] = t[r].bind(t), "document" === e ? e = t.element.ownerDocument : "window" === e ? e = window : i(t[e]) ? e = t[e] : i(t[e].element) && (e = t[e].element), e && o.forEach(function (n) {
			...
			j = function (t) {
				var n = O(t);
				return n.unshift({}), f.apply(null, n)
			},
			E = function (t, n) {
				if (t && "object" === (void 0 === t ? "undefined" : l(t)) && i(n)) {
					t.element = n;
					var e = {
						$set: function (t, n) {
							if (t && void 0 !== n && void 0 !== this.properties && this.properties.hasOwnProperty(t)) {
								var e = p(this.properties[t]),
								...
								if (e.readOnly && void 0 !== r.writable) {
									...
									return void Object.defineProperty(this, t, o)
								}
								this[t] = n
							}
						},
						init: function () {
							m(this), x(this), u(t.init) && t.init.call(this)
						},
						destroy: function () {
							var n = this;
								...
								t.args.forEach(function (t) {
									if (-1 !== t.indexOf(".")) {
										var r = b(t, n),
											i = r.prop,
											c = r.parent;
										Object(o.unwatch)(c, i, n[e])
									} else Object(o.unwatch)(n, t, n[e])
								})
							}), w(t).forEach(function (t) {
								var e = t.element,
									r = t.fn,
									o = t.events;
								"document" === e ? e = n.element.ownerDocument : "window" === e ? e = window : i(n[e]) ? e = n[e] : i(n[e].element) && (e = n[e].element), e && o.forEach(function (t) {
						...
						fire: function (t) {
							var n = void 0;
							if ("CustomEvent" in window && "object" === l(window.CustomEvent)) try {
								n = new CustomEvent(t, {
									bubbles: !1,
									cancelable: !1
								})
							...
							} else n = document.createEvent("Event"), n.initEvent(t, !1, !0);
					...
					return _(t), e = f({}, j(t), t, e), e.init(), e
				}
			},
			A = function (t) {
				return t.replace(/(\-[a-z])/g, function (t) {
			...
			P = {
				...
				upgradeElement: function (t, n) {
					var e = this;
					if (void 0 === n) return void this._registered.forEach(function (n) {
					...
					if (!o || null !== r && -1 !== r.indexOf(n)) {
						...
						if (c) {
							...
							delete u.factory, c.__domFactoryConfig = u, this._created.push(c), Object.defineProperty(t, A(n), {
								configurable: !0,
								writable: !1,
								value: c
							}), o.callbacks.forEach(function (n) {
								return n(t)
							}), c.fire("domfactory-component-upgraded")
						}
					}
				},
				upgrade: function (t) {
					...
					if (void 0 === t) this.upgradeAll();
						...
						var e = this.findRegistered(t);
						e && [].concat(r(document.querySelectorAll("." + e.cssClass))).forEach(function (e) {
				...
				downgrade: function (t) {
					var n = this;
					t instanceof Array || t instanceof NodeList ? (t instanceof NodeList ? [].concat(r(t)) : t).forEach(function (t) {
		...
		var r = e(0),
			...
			a = function (t, n, e) {
				...
				v && (e = n);
				for (f in e) s = !d && b && void 0 !== b[f], l = (s ? b : e)[f], p = y && s ? u(l, r) : _ && "function" == typeof l ? u(Function.call, l) : l, b && c(b, f, l, t & a.U), g[f] != l && i(g, f, p), _ && m[f] != l && (m[f] = l)
			};
		...
		t.exports = function (t, n) {
			...
			return function (n, u, v) {
				for (var h, _, y = i(n), b = o(y), g = r(u, v, 3), m = c(b.length), w = 0, x = e ? d(n, m) : a ? d(n, 0) : void 0; m > w; w++)
					if ((p || w in b) && (h = b[w], _ = g(h, w, y), t))
						if (e) x[w] = _;
						else if (_) switch (t) {
							case 3:
								return !0;
		...
		var r = e(9)("unscopables"),
			o = Array.prototype;
		void 0 == o[r] && e(2)(o, r, {}), t.exports = function (t) {
			o[r][t] = !0
		}
	}, function (t, n, e) {
		! function (n, e) {
				...
				return function (t) {
					...
					var o = e(4),
						...
						a = (n.watch = function () {
							...
							var r = n[1];
							s(r) ? b.apply(void 0, n) : a(r) ? m.apply(void 0, n) : g.apply(void 0, n)
						}, n.unwatch = function () {
							for (var t = arguments.length, n = Array(t), e = 0; t > e; e++) n[e] = arguments[e];
							var r = n[1];
							s(r) || void 0 === r ? j.apply(void 0, n) : a(r) ? x.apply(void 0, n) : w.apply(void 0, n)
						}, function (t) {
							return "[object Array]" === {}.toString.call(t)
						}),
						f = function (t) {
						...
						d = function (t, n, e, r, o) {
							var i = void 0,
								c = t.__watchers__[n];
							(i = t.__watchers__.__watchall__) && (c = c ? c.concat(i) : i);
							for (var u = c ? c.length : 0, a = 0; u > a; a++) c[a].call(t, e, r, n, o)
						},
						v = ["pop", "push", "reverse", "shift", "sort", "unshift", "splice"],
						h = function (t, n, e, r) {
							l(t, e, function () {
								for (var o = 0, i = void 0, c = void 0, u = arguments.length, a = Array(u), f = 0; u > f; f++) a[f] = arguments[f];
								if ("splice" === e) {
									var s = a[0],
										l = s + a[1];
									i = t.slice(s, l), c = [];
									for (var p = 2; p < a.length; p++) c[p - 2] = a[p];
									o = s
								} else c = "push" === e || "unshift" === e ? a.length > 0 ? a : void 0 : a.length > 0 ? a[0] : void 0;
								var d = n.apply(t, a);
								return "pop" === e ? (i = d, o = t.length) : "push" === e ? o = t.length - 1 : "shift" === e ? i = d : "unshift" !== e && void 0 === c && (c = d), r.call(t, o, e, c, i), d
							})
						},
						_ = function (t, n) {
						...
						y = function (t, n, e, r) {
							var o = !1,
								c = a(t);
							void 0 === t.__watchers__ && (l(t, "__watchers__", {}), c && _(t, function (e, o, i, c) {
								if (d(t, e, i, c, o), 0 !== r && i && (f(i) || a(i))) {
									var u = void 0,
										s = t.__watchers__[n];
									(u = t.__watchers__.__watchall__) && (s = s ? s.concat(u) : u);
									for (var l = s ? s.length : 0, p = 0; l > p; p++)
										if ("splice" !== o) b(i, s[p], void 0 === r ? r : r - 1);
										else
											for (var v = 0; v < i.length; v++) b(i[v], s[p], void 0 === r ? r : r - 1)
								}
							})), void 0 === t.__proxy__ && l(t, "__proxy__", {}), void 0 === t.__watchers__[n] && (t.__watchers__[n] = [], c || (o = !0));
							...
							t.__watchers__[n].push(e), o && function () {
								...
								void 0 !== e ? function () {
									...
									["get", "set"].forEach(function (n) {
										...
										void 0 !== e[t] && (r[t] = e[t])
									}), (0, u.default)(t.__proxy__, n, r)
								}() : t.__proxy__[n] = t[n], p(t, n, function () {
									return t.__proxy__[n]
								}, function (e) {
									var o = t.__proxy__[n];
									if (0 !== r && t[n] && (f(t[n]) || a(t[n])) && !t[n].__watchers__)
										for (var i = 0; i < t.__watchers__[n].length; i++) b(t[n], t.__watchers__[n][i], void 0 === r ? r : r - 1);
									o !== e && (t.__proxy__[n] = e, d(t, n, e, o, "set"))
								})
							}()
						},
						b = function t(n, e, r) {
							if ("string" != typeof n && (n instanceof Object || a(n)))
								if (a(n)) {
									...
									var i = [];
									for (var c in n) ({}).hasOwnProperty.call(n, c) && i.push(c);
									m(n, i, e, r)
								}
						},
						g = function (t, n, e, r) {
							"string" != typeof t && (t instanceof Object || a(t)) && (s(t[n]) || (null !== t[n] && (void 0 === r || r > 0) && b(t[n], e, void 0 !== r ? r - 1 : r), y(t, n, e, r)))
						},
						m = function (t, n, e, r) {
						...
						x = function (t, n, e) {
							for (var r in n) n.hasOwnProperty(r) && w(t, n[r], e)
						},
						O = function t(n, e) {
							var r = [];
					...
					var r = e(13),
						...
						u = function (t, n, e) {
							var a, f, s, l = t & u.F,
								...
								b = p ? r : d ? r[n] : (r[n] || {})[c];
							p && (e = n);
							for (a in e) (f = !l && b && a in b) && a in y || (s = f ? b[a] : e[a], y[a] = p && "function" != typeof b[a] ? e[a] : h && f ? i(s, r) : _ && b[a] == s ? function (t) {
								var n = function (n) {
									return this instanceof t ? new t(n) : t(n)
								};
								return n[c] = t[c], n
							}(s) : v && "function" == typeof s ? i(Function.call, s) : s, v && ((y[c] || (y[c] = {}))[a] = s))
						};
