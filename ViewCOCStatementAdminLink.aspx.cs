...
namespace InspectIT
{
    public partial class ViewCOCStatementAdminLink : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DLdb.RS.Open();
            DLdb.SQLST.CommandText = "SELECT TOP 500 * FROM COCStatements where isactive = '1' order by CreateDate desc";
                ...
                while (theSqlDataReader.Read())
                {
                   ...
                   // DateTime pDate = Convert.ToDateTime(theSqlDataReader["DatePurchased"].ToString());
                    ...
                    COCStatement.InnerHtml += "<tr>" +
                                                ...
                                                "<td>" + status + "</td>" +
                                                "<td>" + plumberName + "</td>" +
                                                "<td>" + plumberContact + "</td>" +
                                                "<td>" + plumberEmail + "</td>" +
                                                "<td style==\"width:320px;\"><div class=\"btn-group\"><div class=\"btn btn-sm btn-primary\" onclick=\"document.location.href='EditCOCStatementAdmin.aspx?cocid=" + DLdb.Encrypt(theSqlDataReader["COCStatementID"].ToString()) + "'\" title=\"Edit\"><i class=\"fa fa-pencil\"></i></div>" + COCPDF + createPdfFromOldSystem + "</div></td>" +
                                            "</tr>";
                    //<div class=\"btn btn-sm btn-primary\" onclick=\"document.location.href='AssignInspector.aspx?cocid=" + DLdb.Encrypt(theSqlDataReader["COCStatementID"].ToString()) + "'\" title=\"Assign Inspector\"><i class=\"fa fa-user\"></i></div>
        ...
        protected void filtDates_Click(object sender, EventArgs e)
        {
            ...
            DLdb.RS.Open();
            DLdb.SQLST.CommandText = "SELECT * FROM COCStatements where isactive = '1' and DatePurchased between '" + start.ToString("yyyy-MM-dd") + " 00:00:01' and '" + end.ToString("yyyy-MM-dd") + " 23:59:59'";
            //DLdb.SQLST.Parameters.AddWithValue("UserID", Session["IIT_UID"].ToString());
            DLdb.SQLST.CommandType = CommandType.Text;
            DLdb.SQLST.Connection = DLdb.RS;
            SqlDataReader theSqlDataReader = DLdb.SQLST.ExecuteReader();
        ...
        protected void Search_Click(object sender, EventArgs e)
        {
            ...
            DLdb.DB_Connect();
            DLdb.RS.Open();
            DLdb.SQLST.CommandText = "SELECT * FROM COCStatements where COCNumber ='"+ COCNumber.Text.ToString()+ "'";
            //DLdb.SQLST.Parameters.AddWithValue("UserID", Session["IIT_UID"].ToString());
            DLdb.SQLST.CommandType = CommandType.Text;
            DLdb.SQLST.Connection = DLdb.RS;
            SqlDataReader theSqlDataReader = DLdb.SQLST.ExecuteReader();
