<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="UserAssessments.aspx.cs" Inherits="InspectIT.UserAssessments" %>
        ...
        <!-- START Form Control-->
            <div class="row">
                <div class="auto-style1">
                    <a href="AddAssessment.aspx">
                        <input type="button" value="Add Activity" class="btn btn-primary" style="float:right;" />
                    </a>
                </div>
            </div> 
        <!-- END Form Control-->
