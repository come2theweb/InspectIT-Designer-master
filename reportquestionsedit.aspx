<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="reportQuestionsEdit.aspx.cs" Inherits="InspectIT.reportQuestionsEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="panel-body">
                ...
                <div class="form-group form-group-default">
                    ...
                    <div class="controls">
                        ...
                        <div class="pull-right"><asp:Button ID="btnUpload" CssClass="btn btn-primary" runat="server" Text="Upload" formnovalidate OnClick="btnUpload_Click1" /></div>
                ...
                <div class="form-group form-group-default">
                    <label>Active :</label>
                    <div class="controls">
                        <asp:CheckBox ID="isActive" runat="server" CssClass="form-control" />
                    </div>
                </div>
                <div class="row">
                    <div class="text-right">
                        <asp:HiddenField ID="CommentID" runat="server" />
                        <asp:Button ID="btn_add" CssClass="btn btn-primary" runat="server" Text="Update Statement" OnClick="btn_add_Click" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function deleteImage(id,pid) {
            ...
            if (result) {
                document.location.href = "DeleteItems.aspx?op=delCommentImg&id=" + id + "&pid=" + pid;
            }
        }
        ...
        function deleteImagea(id,pid) {
            var result = confirm("Are you sure?");
            if (result) {
                document.location.href = "DeleteItems.aspx?op=delReferenceImg&id=" + id + "&pid=" + pid;
            }
        }
