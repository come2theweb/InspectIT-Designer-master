...
namespace InspectIT
{
    public partial class UserOrders : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("OrderNewCard.aspx");
        }

        protected void payRegistration_Click(object sender, EventArgs e)
        {
            Response.Redirect("PayRegistration.aspx");
        }

        protected void AssessmentFee_Click(object sender, EventArgs e)
        {
            Response.Redirect("AssessmentFeePay.aspx");
        }
    }
}