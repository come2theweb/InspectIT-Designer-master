<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="installationTypesAdd.aspx.cs" Inherits="InspectIT.installationTypesAdd" %>
        ...
        <div class="panel panel-transparent">
            ...
            <div class="panel-body">
                ...
                <div class="form-group form-group-default">
                    ...
                    <div class="controls">
                        <asp:TextBox ID="InstallationType" runat="server" placeholder="Enter an Installtion Type" CssClass="form-control" required></asp:TextBox>
                    </div>
                </div>
