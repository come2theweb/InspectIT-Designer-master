...
namespace InspectIT
{
    public partial class newApplications : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DLdb.RS.Open();
            DLdb.SQLST.CommandText = "SELECT * FROM NewApplications where isActive='1' and isRejected='0' and isApproved='0'";
                ...
                while (theSqlDataReader.Read())
                {
                    ...
                    if (theSqlDataReader2.HasRows)
                    {
                        while (theSqlDataReader2.Read())
                        {
                            ...
                            if (theSqlDataReader2["IDPhoto"].ToString() != "" && theSqlDataReader2["IDPhoto"] != DBNull.Value)
                            {
                                IDPhoto = checkImg;
                            }
                        }
                    ...
                    displayusers.InnerHtml += "<tr>" +
                                                       ...
                                                       "<td><a href='NewPlumberRegistrationAdmin?npid=" + DLdb.Encrypt(theSqlDataReader["ApplicationID"].ToString()) + "'><div class=\"btn btn-sm btn-primary\" title=\"Edit\"><i class=\"fa fa-pencil\"></i></div></a></td>" +
                                                   "</tr>";
                }
            }
