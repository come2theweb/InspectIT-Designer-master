<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewPlumberRegistrationUpdate.aspx.cs" Inherits="InspectIT.NewPlumberRegistrationUpdate" %>
    ...
    <form runat="server">
        ...
        <div class="d-flex flex-column flex-1 layout-boxed">
            ...
            <div class="navbar navbar-expand-md navbar-light">
                <h4 class="text-center">Plumber Update Designation</h4>
            </div>
            <!-- /main navbar -->
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-default required">
                                                            ...
                                                            <div class="controls">
                                                                <div class="col-md-4">
                                                                    <asp:TextBox ID="regno" CssClass="form-control" runat="server" required></asp:TextBox>
                                                                ...
                                                                <div class="col-md-2">
                                                                    ...
                                                                    <asp:Button ID="searchRegNo" runat="server" CssClass="btn btn-primary" Text="Search RegNo" OnClick="searchRegNo_Click" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="card">
                                ...
                                <div id="accordion-control-group6" class="collapse" data-parent="#accordion-control">
                                    <div class="card-body">
                                        ...
                                        <div class="col-md-12">
                                            Please select the relevant designation being updated. To view the designation requirements <a href="http://pirb.co.za/wp-content/uploads/2015/07/A0-Designation-Poster_2017-10-09_Digital-1.pdf" target="_blank">Click here</a>
                                        </div>
                                ...
                                <div id="accordion-control-group10" class="collapse" data-parent="#accordion-control">
                                    <div class="card-body">
                                        <div class="col-md-12">
                                          ...
                                          <div class="form-group form-group-default">
                                              <label>
                                                  I declare that I have fully read and understood the declaration:</label>
                                              <div class="controls">
