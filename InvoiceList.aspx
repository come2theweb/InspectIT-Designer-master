<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="InvoiceList.aspx.cs" Inherits="InspectIT.InvoiceList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-transparent">
        ...
        <div class="panel-title">Transactions
        </div>
        ...
        <div class="alert alert-danger" id="errormsg" runat="server" visible="false"></div>
            ...
            <div class="tab-pane active" id="TabActive">
                ...
                <table class="table table-striped demo-table-search" id="stripedTable">
                    <thead>
                    <tr>
                        <th>Invoice ID</th> <!-- auditid / orderid -->
                        <th>COC Statement ID</th> <!-- cocstatementid /  -->
                        <th>Inspector / Plumber</th> <!-- userid / userid -->
                        <th>COC Type</th> <!-- description / coctype -->
                        <th>Completed On</th> <!--  -->
                        <th>Invoice</th> <!-- invoice / pdfname -->
                        <th>Total Amount</th> <!-- totalamount / total -->
                        <th>Origin</th> <!-- COCInspectors / Orders -->
                        <th>Reconned</th>
                    </tr>
                    </thead>
    ...
    <script>
        ...
        function InspecChangeIsReconned(AuditID) {
            document.location.href = "API/InspecReconned.aspx?aid=" + AuditID;
        }
        function InspecChangeIsNotReconned(AuditID) {
            document.location.href = "API/InspecReconned.aspx?aid=" + AuditID;
        }
        function PlumberChangeIsReconned(OrderID) {
            document.location.href = "API/PlumberReconned.aspx?oid=" + OrderID;
        }
        function PlumberChangeIsNotReconned(OrderID) {
            document.location.href = "API/PlumberReconned.aspx?oid=" + OrderID;
        }
