<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="EditRates.aspx.cs" Inherits="InspectIT.EditRates" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group form-group-default">
                                ...
                                <div class="controls">
                                    <asp:TextBox ID="validDate" runat="server" CssClass="form-control"  ></asp:TextBox>
                                </div>
                            </div>
