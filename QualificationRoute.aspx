<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QualificationRoute.aspx.cs" Inherits="InspectIT.QualificationRoute" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-transparent">
        ...
        <div class="panel-title">Qualification Route
        </div>
        ...
        <div class="alert alert-danger" id="errormsg" runat="server" visible="false"></div>
            ...
            <div class="tab-pane active" id="TabActive">
                ...
                <table class="table table-striped demo-table-search" id="stripedTable">
                    <thead>
                    <tr>
                        <th>Qualification Route Type</th> 
                        <th>isActive</th> 
                        <th></th> 
                    </tr>
                    </thead>
