...
namespace InspectIT
{
    public partial class AssessmentsQueue : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DLdb.RS.Open();
            DLdb.SQLST.CommandText = "SELECT * FROM AssessmentDetails where isActive='1'";
            ...
            if (theSqlDataReader.HasRows)
            {
                while (theSqlDataReader.Read())
                {
                    ...
                    displayusers.InnerHtml += "<tr>" +
                                                    ...
                                                    "<td><a href='AssessmentsQueueEdit?aid=" + DLdb.Encrypt(theSqlDataReader["AssessID"].ToString()) + "'><div class=\"btn btn-sm btn-primary\" title=\"Edit\"><i class=\"fa fa-pencil\"></i></div></a>" +
                                                    "</td>" +
                                                "</tr>";
                }
            }
        ...
        {
            Response.Redirect("AssessmentsQueueEdit");
        }
    }
}