<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PayRegistration.aspx.cs" Inherits="InspectIT.PayRegistration" %>
        ...
        <div class="panel panel-transparent">
            ...
            <div class="panel-body">
                ...
                <div class="form-group form-group-default">
                    ...
                    <div class="controls">
                        <asp:TextBox ID="RegistrationFee" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="form-group form-group-default">
                    ...
                    <div class="controls">
                        <asp:TextBox ID="cardCost" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group form-group-default">
                    <label>Late Registration Fees applicable :</label>
                    <div class="controls">
                        <asp:TextBox ID="lateRegistrationFee" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                    </div>
                </div>
