...
namespace InspectIT
{
    public partial class PF_notifyURLOther : System.Web.UI.Page
    {
        string orderId = "";
            ...
            try
            {
                ...
                if (paymentStatus == "COMPLETE")
                {
                    ...
                    if (theSqlDataReader.HasRows)
                    {
                        ...
                        AssessmentLocation = theSqlDataReader["AssessmentLocation"].ToString();
                        AssessmentType = theSqlDataReader["AssessmentType"].ToString();
                        ...
                        else
                        {
                            ...
                            registrationItems += "                               <tr>" +
                                                        ...
                                                        "                                </tr>";
                            registrationItems += "                               <tr>" +
                                                       "                                   <th style=\"border: 1px solid #E5E5E5;\" valign='middle'> Type: "+ AssessmentType + "</th>" +
                                                       "                                   <th style=\"border: 1px solid #E5E5E5;\" valign='middle'>1</th>" +
                                                       "                                   <th style=\"border: 1px solid #E5E5E5;\" valign='middle'></th>" +
                                                       "                                   <th style=\"border: 1px solid #E5E5E5;\" valign='middle'></th>" +
                                                       "                                </tr>";
                            registrationItems += "                               <tr>" +
                                                       "                                   <th style=\"border: 1px solid #E5E5E5;\" valign='middle'> Where: " + AssessmentLocation + "</th>" +
                                                       "                                   <th style=\"border: 1px solid #E5E5E5;\" valign='middle'>1</th>" +
                                                       "                                   <th style=\"border: 1px solid #E5E5E5;\" valign='middle'></th>" +
                                                       "                                   <th style=\"border: 1px solid #E5E5E5;\" valign='middle'></th>" +
                                                       "                                </tr>";
