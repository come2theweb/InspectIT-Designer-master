...
namespace InspectIT
{
    public partial class CompanyPointsEdit : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                DLdb.RS.Open();
                DLdb.SQLST.CommandText = "SELECT * FROM CompanyPoints where PointID=@PointID";
        ...
        protected void btnUpdatePlumber_Click(object sender, EventArgs e)
        {
            ...
            DLdb.SQLST.CommandText = "UPDATE CompanyPoints SET Item=@Item,Points=@Points WHERE PointID=@PointID";
            DLdb.SQLST.Parameters.AddWithValue("PointID", DLdb.Decrypt(Request.QueryString["id"].ToString()));
            ...
            DLdb.DB_Close();
            Response.Redirect("CompanyPoints.aspx?msg=" + DLdb.Encrypt("Company Points has been updated"));
        }
    }
}