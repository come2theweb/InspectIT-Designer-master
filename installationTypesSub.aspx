<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="installationTypesSub.aspx.cs" Inherits="InspectIT.installationTypesSub" %>
            ...
            <div class="panel-body">
                ...
                <div class="row" runat="server" id="addITBtn">
                    <div class="auto-style1">
                        <a href="installationTypesSubAdd.aspx">
                            <input type="button" value="Add Sub Type" class="btn btn-primary" style="float: right;" />
                        </a>
                    </div>
                </div>
                <!-- END Form Control-->
