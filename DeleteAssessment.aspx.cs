...
namespace InspectIT
{
    public partial class DeleteAssessment : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["op"].ToString() == "del")
            {
                ...
                DLdb.RS.Close();
                DLdb.DB_Close();
                Response.Redirect("UserAssessments.aspx?msg=" + DLdb.Encrypt("Assessment has been deleted"));
            }
            else
            {
                DLdb.RS.Open();
                ...
                DLdb.RS.Close();
                DLdb.DB_Close();
                Response.Redirect("UserAssessments.aspx?msg=" + DLdb.Encrypt("Assessment has been added"));
            }
