<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="RatesMaintain.aspx.cs" Inherits="InspectIT.RatesMaintain" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-transparent">
        ...
        <div class="panel-title">Maintenance Rates
        </div>
        ...
        <!-- START Form Control-->
            <div class="row">
                <div class="auto-style1">
                    <a href="RatesMaintainAdd.aspx">
                        <input type="button" value="Add" class="btn btn-primary" style="float:right;" />
                    </a>
                </div>
            </div> 
        <!-- END Form Control-->
