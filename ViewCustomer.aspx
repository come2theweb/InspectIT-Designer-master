<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ViewCustomer.aspx.cs" Inherits="InspectIT.ViewCustomer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-transparent">
        ...
        <div class="panel-title">View Customers
        </div>
            ...
            <div class="row">
                <div class="auto-style1">
                    <a href="AddCustomer.aspx">
                        <input type="button" value="Add New Customer" Class="btn btn-primary" style="float:right;" />
                    </a>
                </div>
            </div> 
        </div>
