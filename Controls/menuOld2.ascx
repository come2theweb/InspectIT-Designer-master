<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="menuOld2.ascx.cs" Inherits="InspectIT.Controls.menuOld2" %>
...
<div class="sidebar-menu" id="adminMenu" runat="server">
        ...
        <ul class="menu-items">
            ...
            <li class="" id="Li2" runat="server">
                ...
                <ul class="sub-menu">
                  <li class="">
                    <a href="ViewPlumbers.aspx">Register</a>
                    <span class="icon-thumbnail">r</span>
                  </li>
                </ul>
            </li>
            ...
            <li class="" id="Li3" runat="server">
                <a href="javascript:;"><span class="title">Registration</span><span class="arrow"></span></a>
                ...
                <ul class="sub-menu">
                  ...
                  <li class="">
                    <a href="newApplicationsUpdate.aspx">Extensions</a>
                    <span class="icon-thumbnail">e</span>
                  </li>
                  <li class="">
                    <a href="companies.aspx">Company List</a>
                    <span class="icon-thumbnail">cl</span>
                  </li>
                  <li class="">
                    <a href="newApplication.aspx">Assessments Q</a>
            ...
            <li class="hide" id="Plumbers" runat="server">
                <a href="javascript:;"><span class="title">Plumbers</span><span class="arrow"></span></a>
                <span class="icon-thumbnail" style="padding-top:10px;"><i class="icon-people"></i></span>
                <ul class="sub-menu">
                  <li class="">
