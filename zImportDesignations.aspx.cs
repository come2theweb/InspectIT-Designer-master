...
namespace InspectIT
{
    public partial class zImportDesignations : System.Web.UI.Page
    {
                ...
                while (theSqlDataReader.Read())
                {
                    ...
                    if (theSqlDataReader2.HasRows)
                    {
                        while (theSqlDataReader2.Read())
                        {
                            ...
                            DLdb.pirbRS3.Open();
                            DLdb.pirbSQLST3.CommandText = "select * from QualificationType where ID=@ID and isDesignations='1' and isSpeciliasations='0'";
                            ...
                            if (theSqlDataReader3.HasRows)
                            {
                                ...
                                Designation = theSqlDataReader3["stuff"].ToString();
                                ...
                                DLdb.DB_Connect();
                                // INSERT INTO PlumberDesignations
                                DLdb.RS4.Open();
                                DLdb.SQLST4.CommandText = "insert into PlumberDesignations (PlumberID,Designation)" +
                                    "values (@PlumberID,@Designation)";
                                DLdb.SQLST4.Parameters.AddWithValue("PlumberID", theSqlDataReader["ID"].ToString());
                                DLdb.SQLST4.Parameters.AddWithValue("Designation", Designation);
