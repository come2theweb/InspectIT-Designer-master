<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PurchasePlumbingCOCSupplierSide.aspx.cs" Inherits="InspectIT.PurchasePlumbingCOCSupplierSide" %>
        ...
        <div class="panel panel-transparent">
            ...
            <div class="panel-body">
                ...
                <div class="form-group form-group-default">
                    <label>Number of Unallocated COC in My Stock :</label>
                    <div class="controls">
                ...
                <!-- START Form Control-->
                <div class="form-group form-group-default">
                    <label>Total Number COC You are Permitted :</label>
                    <div class="controls">
                ...
                <div class="form-group form-group-default hide">
                    ...
                    <div class="">
                        <%--<asp:RadioButton CssClass="radio" ID="ElectronicCOC" Text=" Electronic" GroupName="RadioGroup1" value="Electronic" runat="server" />--%>
                        <asp:RadioButton CssClass="radio" ID="PaperBasedCOC" Text=" Paper Based" Checked="True" GroupName="RadioGroup1" runat="server" value="Paper" />
                    </div>
                </div>
                ...
                <div class="form-group form-group-default">
                    ...
                    <div class="controls">
                        <asp:TextBox ID="NoCOCsPurchase" runat="server" CssClass="form-control" TextMode="Number"  OnTextChanged="NoCOCsPurchase_TextChanged" AutoPostBack="true" style="background-color:#f0f0f0;"></asp:TextBox>
                        
                    </div>
                </div>
                <div id="paperdel" runat="server" >
                    <div class="form-group form-group-default">
                ...
                <div class="form-group form-group-default">
                    ...
                    <div class="controls">
                        <asp:CheckBox  CssClass="checkbox check-success chckbxChecked" ID="DisclaimerAgreementPurchaseCOC" TextAlign="Right" runat="server" Text="I declare and understand:" />
                        <ul>
                            ...
                            <li>That the PIRB Plumbing Certificate of Compliance are kept in a secure environment and an individual be nominated to handle the Plumbing COC’s.</li>
                            <li>The system allocation of Plumbing COC’s to a Licensed Plumbers name must be done immediately on the PIRB Inspect-it System after the physical allocation (sale) has taken place.</li>
                        </ul>
                ...
                <div class="row">
                    <div class="auto-style1">
                        <a href="ViewCOCStatementSupplier.aspx">
                            ...
                            <asp:Button ID="btn_buy" disabled runat="server" Text="Purchase" cssclass="btn btn-primary" style="float: right;" OnClick="btn_buy_Click" />
