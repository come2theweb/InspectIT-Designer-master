<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="reportQuestions.aspx.cs" Inherits="InspectIT.reportQuestions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-transparent">
        ...
        <div class="panel-title">Report Statement Listings
        </div>
        ...
        <!-- START Form Control-->
            <div class="row" runat="server" id="addQBtn">
                <div class="auto-style1">
                    <a href="reportQuestionsAdd.aspx">
                        <input type="button" value="Add Statement" class="btn btn-primary" style="float:right;" />
                    </a>
                </div>
            </div> 
        <!-- END Form Control-->
